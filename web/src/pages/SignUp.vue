<template>
    ...
    >
        <h1 class="text-4xl font-semibold text-center my-4">Signup</h1>
        <form
...
export default {
    setup() {
        ...
        const signup = async () => {
            ...
            const returnedErrorMessage = await store.dispatch("signup", {
        ...
        return { username, password, signup, isError, errorMessage };
    },
};
</script>
